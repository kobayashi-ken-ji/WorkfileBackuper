...
const WCHAR* Backup::createThread(const ConfigStruct& config) {
...
// スレッドを終了
// @returns ハンドル開放の成否
bool Backup::closeThread(bool notificationFlag) {
...
// スレッド関数 [静的]
DWORD WINAPI Backup::thredFunc(LPVOID lpParamete) {
...
//      message1
//      message2
void Backup::updateHistory(const WCHAR* message1, const WCHAR* message2) const {
