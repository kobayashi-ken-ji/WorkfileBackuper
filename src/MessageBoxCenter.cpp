#pragma once
#include "../include/MessageBoxCenter.h"
#include <CommCtrl.h>
...
// メッセージボックス 作成
int MessageBoxCenter::create(LPCWSTR text, LPCWSTR caption, UINT type) {
...
LRESULT CALLBACK MessageBoxCenter::hookProc(int nCode, WPARAM wParam, LPARAM lParam) {
...
LRESULT CALLBACK MessageBoxCenter::subclassProc(
